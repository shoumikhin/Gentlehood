...
NSUInteger const kGHPostsPerPageDefault = 10;
NSString * const kGHWebCellID = @"WebCell";
NSString * const kGHVocabularyCellID = @"VocabularyCell";
NSString * const kGHVocabularyDefineSegue = @"VocabularyDefine";
NSString * const kFetchCacheName = @"Cache";
NSString * const kImageCacheDirectory = @"Images";
CGFloat const kUITableViewCellHeightDefault = 44.0;
