...
- (UITableViewCell*)newCellForIdentifier:(NSString*)identifier {
	...
	cell.textLabel.minimumScaleFactor = kIASKMinimumFontSize / kIASKLabelFontSize;
	cell.detailTextLabel.minimumScaleFactor = kIASKMinimumFontSize / kIASKLabelFontSize;
	return cell;
}
