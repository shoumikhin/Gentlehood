...
parser.add_option('-i', '--ipa-name', action='store', dest='ipa_name', help='ipa filename')
...
class IPAGenerator(object):
    ...
    def generate_html(self, app_name):
        ...
        HTML_FILENAME = options.ipa_name + '.html'
    ...
    def generate_manifest(self, app_name):
        ...
        MANIFEST_FILENAME = options.ipa_name + '.plist'
                ...
                [
                 {
                    ...
                    'url' : urlparse.urljoin(options.deployment_address, options.ipa_name),
                 }
                ],
                'metadata' :
                {
    ...
    def template(self, app_name):
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="container">
                <h1>iOS 6.0+ Users:</h1>
                <div class="link"><a href="itms-services://?action=download-manifest&url=[DEPLOYMENT_PATH]">Tap here to install<br />application<br />On Your Device</a></div>
                <p>
                    <strong>Link didn't work?</strong><br/>
        ...
        template_html = string.replace(template_html, TEMPLATE_PLACEHOLDER_ARCHIVE_FILENAME, app_name + ".ipa")
