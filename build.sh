...
package()
{
    ...
    ./manifest.py -f "$OUTPUT_DIR/${PROJECT_NAME}.app" -d "http://j.mp/shoumikhin-build/${PROJECT_NAME}.plist" -a "" -c "manifest_log.txt" -i "http://j.mp/shoumikhin-build/${PROJECT_NAME}.ipa" || die
